...
> Inspired by the agent conventions from [pingdotgg/t3code](https://github.com/pingdotgg/t3code).
> Adapted and extended for the **InkDown** project.
...
All secrets are in `.env.local` (never committed). See `.env.example` for required keys:
